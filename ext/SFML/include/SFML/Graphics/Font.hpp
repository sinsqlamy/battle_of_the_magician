...
/// use the sf::Text class, which is able to properly output SFMLText
...
/// glyphs data and metrics of a sf::Font to display any SFMLText on a
/// render target.
...
/// }
///
/// // Create a SFMLText which uses our font
/// sf::Text text1;
/// text1.setFont(font);
/// text1.setCharacterSize(30);
/// text1.setStyle(sf::Text::Regular);
///
/// // Create another SFMLText using the same font, but with different parameters
/// sf::Text text2;
/// text2.setFont(font);
...
/// If you need to display SFMLText of a certain size, make sure the
