...
public:
    ...
    /// The source must be a SFMLText file containing a valid
    ...
    /// The sources must be SFMLText files containing valid shaders
...
/// of the SFMLText is not the actual SFMLText that you see on screen, it is
